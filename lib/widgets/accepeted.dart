    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          SizedBox(height: 5,),
          Center(child: Text('تمت مراجعة منشورك والموافقة عليه \nاضغط على الزر في الاسفل لمشاهدة منشورك ' , style: TextStyle(fontFamily: 'Tj', color: Color(0xff8A8A8A), fontSize: 14),)),
          SizedBox(height: 70,),
          Center(
