...
class _FavoriteState extends State<Favorite> {
  List<FavoriteModel> _favourite = [];
  bool favorite = true;
  Future<List<FavoriteModel>> getData()async{
    _favourite=await FavoriteApiController().getFavouriteLists();
    return _favourite;
  }
  @override
  void initState() {
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Column(
              children: [
                ...
                Center(
                    child: Text(
                  'اضغط على رمز القلب الذي بقرب العقار \n لاضافته الى قائمة العقارات المميزة',
                  style: TextStyle(
                      fontFamily: 'Tj',
                      fontSize: 14.sp,
